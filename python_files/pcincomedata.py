...
dataset.columns = ['name','per_capita_income','state_id','county_id','item','year']
...
dataset.columns =['per_capita_income','state_id','county_id','year','county','state']

with s3.open('census-stats-tejas-b/percapitaincomedata.csv','w') as f:
