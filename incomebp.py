...
dataset.columns = ['name','below_poverty_level_income','state_id','county_id','item','year']
...
dataset.columns =['below_poverty_level_income','state_id','county_id','year','county','state']

with s3.open('census-stats-tejas-b/incomebp.csv','w') as f:
